...
select * from jeonnam where 시군구 ='강진군' and 읍면 like '%강진읍%' and 리명 like '%%' and 도로명 like '%종합운동장길%' and 법정동명 like '%%' and 건물번호본번 like '%50%' and 건물번호부번  like '%50%' and 지번본번 like '%%' and 시군구용건물명  like '%%'
