...
<head>
	...
	<script>
		function AutoInput(zipcode,address1){
			...
			opener.document.register.address1.value=address1;
			self.close();
		}
	</script>
	<style>
...
<tr>
	<td bgcolor="#eeeeee">
		<center>
			<font size=3 color="#ffffff">
				<%System.out.println(우편번호+","+신주소); %>
				<a href="JavaScript:AutoInput('<%=우편번호%>','<%=신주소%>')"><%=우편번호%></a>
			</font>
		</center>
	</td>
	...
	<td bgcolor="#eeeeee">
		<font size=3 color="#ffffff">
			<center><a href="Javascript:AutoInput('<%=우편번호%>','<%=신주소%>')"><%=신주소%></a><br>
			<center><a href="Javascript:AutoInput('<%=우편번호%>','<%=구주소%>')"><%=구주소%></a></center>
		</font>
	</td>
</tr>
...
다시 검색 하시려면 <a href="DoroForm.jsp">요기</a>를 누르세요 ~
</center>
</font>
